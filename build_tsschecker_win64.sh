...
export C_INCLUDE_PATH=$C_INCLUDE_PATH:/tmp/tsschecker_build_win64/include
export CPLUS_INCLUDE_PATH=$CPLUS_INCLUDE_PATH:/tmp/tsschecker_build_win64/include
export OBJC_INCLUDE_PATH=$OBJC_INCLUDE_PATH:/tmp/tsschecker_build_win64/include
sleep 1
