...
pacman -S --needed --noconfirm mingw-w64-ucrt-x86_64-toolchain mingw-w64-ucrt-x86_64-libzip
...
sleep 1
cp tsschecker/tsschecker.exe ../../tsschecker_win-ucrt64.exe
cd ../..
echo "Compiling complete!"
echo "tsschecker_win-ucrt64.exe can be found inside the working directory"
sleep 1
